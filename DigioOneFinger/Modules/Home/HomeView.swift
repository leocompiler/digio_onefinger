...
class HomeView: LayoutTools  {
    ...
    lazy var spotLightView = CollectionImageView(listItens: [],identfier: "spot", delegate: self,type: .SPOTLIGHT,width:width,height:100)
        ...
        lazy var productView = CollectionImageView(listItens: [],identfier: "product", delegate: self,type: .PRODUCT,width:100,height:100)
